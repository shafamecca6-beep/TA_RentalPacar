            ...
            <div class="col-md-6">
                <div class="card shadow mb-4">
                    <div class="card-body text-center">
                        <img src="https://i.pinimg.com/736x/3d/b8/dd/3db8dd9e5a160214f63dbf7f44084d8c.jpg" alt="Foto Profil Jule" class="rounded-circle mb-3" style="width: 150px; height: 150px; object-fit: cover;">
                ...
                <div class="d-grid gap-3">
                    ...
                    <a href="{{ route('order', 3) }}" class="btn btn-primary btn-lg">Order Now</a>
                </div>
            </div>
        </div>
    </div>
